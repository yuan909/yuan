						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="checkbox" id="expressTrait1" name="expressTrait"
									value="耐心" aria-required="true" required/>耐心
								<input type="checkbox" id="expressTrait2" name="expressTrait"
									value="干练" aria-required="true" required/>干练
								<input type="checkbox" id="expressTrait3" name="expressTrait"
									value="效率" aria-required="true" required/>效率
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
								<td>
								  <input placeholder="入职时间" id="entryTime" name="entryTime"
                     				 class="laydate-icon form-control layer-date" readonly="readonly"/>
									</td>
							</tr>
							<tr>
