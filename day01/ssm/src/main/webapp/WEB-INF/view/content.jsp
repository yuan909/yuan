...
<body class="gray-bg">
	<div class="panel-body">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">广告分类类型</span>
					<select class="form-control" name="contencategoryid" id = "contencategoryid">
					...
					<form id="form_user" method="post" action="reserveContent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>广告分类名称：</td>
								<td colspan="4">
									<select class="form-control" name="contencategoryid" id="contencategoryid" aria-required="true" required>
							...
							<tr>
								<td>图片路径：</td>
								<td>
									<img id="pinpath" src="" width="50px" height="50px">
							...
							<tr>
								<td>创建时间：</td>
								<td>
								 <input placeholder="创建时间" id="createtime" name="createtime" 
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						<form id="form_user_import" action="importContent.htm" method="post" enctype="multipart/form-data">
	...
	var TableInit = function () {
	    ...
	    oTableInit.Init = function () {
	        $('#table_user').bootstrapTable({
	            ...
	            pageSize: 10,                       //每页的记录行数（*）
	            pageList: [10, 25, 50, 75, 90],    //可供选择的每页的行数（*）
	           ...
	           // height: 500,                        //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
	            ...
	            },
	            {
	                ...
	                formatter:function(value,row,index){
	                	return '<img src="/img/'+value+'" width="50px" heigh="50px"/>';
	                }
	            },
	            {
	                field: 'contenturl',
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            contencategoryid: $("#contencategoryid").val(),
	...
	function initEditUser(getSelection){
		...
		$('#contencategoryid').val(getSelection.contencategoryid);
