					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>人员性别：</td>
								<td>
								<input type="radio" id="pSex" name="pSex"
							...
							<tr>
								<td>人员爱好：</td>
								<td>
								<input type="checkbox" id="pLike1" name="pLike"
									value="篮球" aria-required="true" required/>篮球
								<input type="checkbox" id="pLike2" name="pLike"
									value="足球" aria-required="true" required/>足球
								<input type="checkbox" id="pLike3" name="pLike"
							...
							<tr>
								...
								<td>存款日期：</td>
								<td>
								 <input placeholder="存款日期" id="createtime" name="createtime" 
                  						class="laydate-icon form-control layer-date" readonly="readonly"/>
									</td>
							</tr>
							<tr>
			...
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_bank" method="post" action="reserveBank.htm">
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-primary"  id="bank_user_btn">保存</button>
							<button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
						</div>
					</form>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form id="form_import" action="importPerson.htm" method="post" enctype="Multipart/from-data">
	    		...
	    		$('#modal_user_echarts').modal({backdrop: 'static', keyboard: false});
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
		    		    		//循环集合
		    			    	res.list.forEach(function(personVo){
