        ...
        <div class="row">
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="text" name="eName" class="form-control" id="eName1" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">部门</span>
					<select class="form-control" name="dDepid" id = "dDepid1">
					...
					<form id="form_user" method="post" action="reserveEmp.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>生日：</td>
								<td>
								<input placeholder="生日" id="birthday" name="birthday" 
                     				class="laydate-icon form-control layer-date" readonly="readonly"/>
									</td>
							</tr>
							<tr>
							...
							<tr>
								<td>头像：</td>
								<td>
									<img id="pic" width="50px" height="50px" src="">
