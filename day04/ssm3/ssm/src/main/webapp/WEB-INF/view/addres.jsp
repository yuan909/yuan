...
<body class="gray-bg">
        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
					...
					<select class="form-control" name="addresId" id = "txt_search_roleid">
						<option value="0">---请选择---</option>
						<c:forEach items="${alist }" var="a">
						 	<option value="${a.addresId}">${a.addresName}</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
					...
					<form id="form_user" method="post" action="reserveExpress.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>快递地址</td>
								<td colspan="4">
									<select class="form-control" name="addresId" id = "addresId" aria-required="true" required>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            addresName: $("#txt_search_roleid").val(),
	...
	function initEditUser(getSelection){
		...
		$('#money').val(getSelection.money);
		$('#addresId').val(getSelection.addresId);
	}
