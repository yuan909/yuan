...
<body class="gray-bg">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="checkbox" id="expressTrait1" name="expressTrait"
									value="认真" aria-required="true" required/>认真
								<input type="checkbox" id="expressTrait2" name="expressTrait"
									value="负责" aria-required="true" required/>负责
								<input type="checkbox" id="expressTrait3" name="expressTrait"
									value="漂亮" aria-required="true" required/>漂亮
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>入职时间：</td>
								<td>
								 <input placeholder="开始时间" id="entryTime" name="entryTime" 
                     				class="laydate-icon form-control layer-date" readonly="readonly"/>
									</td>
							</tr>
							<tr>
								...
								<td>创建时间：</td>
								<td>
								<input placeholder="开始时间" id="createTime" name="createTime" 
                     				class="laydate-icon form-control layer-date" readonly="readonly"/>
									</td>
							</tr>
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait1').prop('checked',getSelection.expressTrait.indexOf("认真")!=-1);
		$('#expressTrait2').prop('checked',getSelection.expressTrait.indexOf("负责")!=-1);
		$('#expressTrait3').prop('checked',getSelection.expressTrait.indexOf("漂亮")!=-1);
