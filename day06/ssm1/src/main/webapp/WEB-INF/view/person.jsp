...
<body class="gray-bg">
	...
	function initEditUser(getSelection){
		...
		$('#expressTrait1').prop('checked',getSelection.expressTrait.indexOf("篮球")!=-1);
		$('#expressTrait2').prop('checked',getSelection.expressTrait.indexOf("足球")!=-1);
		$('#expressTrait3').prop('checked',getSelection.expressTrait.indexOf("排球")!=-1);
