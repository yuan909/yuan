        ...
        <div class="row">
			  ...
			  <div class="col-lg-3">
				<div class="input-group">
			      ...
			      <input type="text" name="phone" class="form-control" id="txt_search_operation" >
				</div>
			  </div>
			  <div class="col-lg-3">
				<div class="input-group">
			      <span class="input-group-addon">详细地址</span>
			      <input type="text" name="address" class="form-control" id="txt_search_module" >
				</div>
			  </div>
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								...
								<input type="radio" id="status" name="status"
									value="营业" aria-required="true" required/>营业
								<input type="radio" id="status" name="status"
									value="倒闭" aria-required="true" required/>倒闭
									</td>
							</tr>
							<tr>
								<td>角色：</td>
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
							<form id="form_import" action="importSchool.htm" method="post" enctype="multipart/from-data">
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            phone: $("#txt_search_operation").val(),
	            address: $("#txt_search_module").val(),
