...
<body class="gray-bg">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveContext.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>图片：</td>
								<td>
										<img src="" id="pinpath" width="50px" height="50px">
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_import" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">					
							<form id="form_import" action="importContent.htm" method="post" enctype="multipart/from-data">
	    		...
	    		$('#modal_user_echarts').modal({backdrop: 'static', keyboard: false});
	    			...
	    			$.ajax({
	    			    ...
	    			    success:function(res){
	    			    	...
	    			    	if(res.success){
		    		    		//循环集合
		    			    	res.list.forEach(function(contentVo){
		    			    		xdata.push(contentVo.cname);
		    			    		ydata.push({value:contentVo.num,name:contentVo.cname});
		    			    	})
		    			    	option = {
		    			    		    title: {
		    			    		        text: '某站点用户访问来源',
	...
	function initEditUser(getSelection){
		...
		$('#pics').val(getSelection.pinpath);//如果不修改图片，将原有的图片赋值给pic
		$('#pinpath').attr('src',"/img/"+getSelection.pinpath);
	}
