...
<body class="gray-bg">
					...
					<form id="form_user" method="post" action="reservePerson.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>人员爱好：</td>
								<td>
								<input type="checkbox" id="pLike" name="pLike"
									value="车" aria-required="true" required/>车
								<input type="checkbox" id="pLike" name="pLike"
									value="表" aria-required="true" required/>表
								<input type="checkbox" id="pLike" name="pLike"
									value="房" aria-required="true" required/>房
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>存款金额：</td>
	...
	function initEditUser(getSelection){
		...
		$('#pLike').prop('checked',getSelection.pLike.indexOf('车')!=-1);
		$('#pLike').prop('checked',getSelection.pLike.indexOf('表')!=-1);
		$('#pLike').prop('checked',getSelection.pLike.indexOf('房')!=-1);
