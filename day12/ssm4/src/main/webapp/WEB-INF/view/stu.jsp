					...
					<form id="form_user" method="post" action="reserveStu.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>学生性别：</td>
								<td>
								<input type="radio" id="sdsex" name="sdsex"
							...
							<tr>
								<td>学生爱好：</td>
								<td>
								<input type="checkbox" id="sdhobby1" name="sdhobby"
									value="篮球" aria-required="true" required/>篮球
								<input type="checkbox" id="sdhobby2" name="sdhobby"
									value="足球" aria-required="true" required/>足球
								<input type="checkbox" id="sdhobby3" name="sdhobby"
									value="排球" aria-required="true" required/>排球
									</td>
								<td>&nbsp;&nbsp;</td>
								<td>学生生日：</td>
								<td>
									 <input placeholder="开始时间" id="sdbirth" name="sdbirth" 
                     					class="laydate-icon form-control layer-date" readonly="readonly"/>
									</td>
							</tr>
							<tr>
								...
								<td colspan="4">
									<select class="form-control" name="mid" id = "mid" aria-required="true" required>
										...
										<c:forEach items="${clist }" var="r"><!-- 实体类滴 -->
